...
export const Home = () => {
    ...
    useEffect(()=>{
        const getTrending=async ()=>{
            try{
                const trendingRecipes=await axios.post('https://recipe-book-api-nu.vercel.app/get-recipes', {condition:"trending"});
                    ...
                    <div className='tile-container mt-8'>
                        ...
                        <>
                            <div key={index} className='trending-element flex h-[35vh] max-h-[55vh] w-[70vw] justify-start bg-cyan-5 space-x-8.5'>
                                <img src={`recipe-book-api-nu.vercel.app${recipe?.imageUrl}`} className='w-60 h-60 hover:opacity-75'/>
